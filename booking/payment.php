...
$_SESSION['GUESTID'] =   $lastguest;
    ...
    for ($i=0; $i < $count_cart  ; $i++) { 
            ...
            $reservation->ROOMID            = $_SESSION['hotel_cart'][$i]['hotelroomid'];
            $reservation->ARRIVAL           = date_format(date_create( $_SESSION['hotel_cart'][$i]['hotelcheckin']), 'Y-m-d');  
            $reservation->DEPARTURE         = date_format(date_create( $_SESSION['hotel_cart'][$i]['hotelcheckout']), 'Y-m-d'); 
            $reservation->RPRICE            = $_SESSION['hotel_cart'][$i]['hotelroomprice'];  
            ...
            @$tot += $_SESSION['hotel_cart'][$i]['hotelroomprice'];
            }

           $item = count($_SESSION['hotel_cart']);
...
?>
        ...
        <tr>
          ...
          <td><?php echo  date_format(date_create( $_SESSION['hotel_cart'][$i]['hotelcheckin']),"m/d/Y"); ?></td>
          <td><?php echo  date_format(date_create( $_SESSION['hotel_cart'][$i]['hotelcheckout']),"m/d/Y"); ?></td>
          <td><?php echo  ' &euro;'. $result->PRICE; ?></td>
          <td><?php echo   $_SESSION['hotel_cart'][$i]['hotelday']; ?></td>
          <td><?php echo ' &euro;'.   $_SESSION['hotel_cart'][$i]['hotelroomprice']; ?></td>
        </tr>
<?php
