...
<title><?php echo isset($title) ? $title . ' | Reservation' :  'Reservation' ; ?></title>
    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i class="fa fa-globe"></i> Reservation
      ...
      <div class="row invoice-info">
        <div class="col-sm-4 invoice-col">
          From
          <address>
            <strong>Hotel Royal</strong><br>
            Strada Rasaritului nr.10<br>
            Constanta, Romania<br>
            Phone: +4070345621<br>
            Email: hotel@contract.com
          </address>
        </div>
        <!-- /.col -->
        <div class="col-sm-4 invoice-col">
